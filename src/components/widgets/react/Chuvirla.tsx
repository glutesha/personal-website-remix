...
function Scene() {
  ...
  const target = useRef(
    new THREE.Vector3(0, camera.position.y, camera.position.z + 3),
  );
...
export const Chuvirla = () => {
  return (
    <div
      className="flex justify-center items-center aspect-square w-90 mdx:w-100 h-auto shrink-0 mx-auto"
      id="glutesha"
    >

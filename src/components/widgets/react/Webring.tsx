...
export const Webring = () => {
    ...
    return (
        <div id="webring" className={
                "fixed z-50 mdx:left-1/2 left-1/2 bottom-2 mdx:bottom-5 -translate-x-1/2 justify-center items-center " +
                ...
                (scrolled ? "translate-y-0" : "translate-y-50 mdx:translate-y-0") +
